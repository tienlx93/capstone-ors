...
<head>
  ...
  <script src="${pageContext.request.contextPath}/javascript/admin/formatDate.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/javascript/admin/appointment.js"></script>
</body>
</html>