          ...
          <div>
            <form action="office?action=editing" method="post">
              ...
              <div class="form-group clearfix">
                ...
                <span class="col-sm-1">${info.floorNumber}</span>
                <label class="col-sm-3">Diện tích:</label>
                <span class="col-sm-1">${info.area} m<SUP>2</SUP></span>
              </div>
              <div class="form-group clearfix">
                <label class="col-sm-3">Thời gian thuê tối thiểu:</label>
                <span class="col-sm-1">${info.minTime} tháng</span>
                <label class="col-sm-3">Diện tích thuê tối thiểu:</label>
                <span class="col-sm-1">${info.minArea} m<SUP>2</SUP></span>
              </div>
